...
@section('title', 'Edit About Page - EMX Auto Repair Admin')
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <textarea class="form-control" id="main_content" data-page-key="main_content" rows="20"></textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="seo_title" placeholder="Result - EMX Auto Repair">
                    </div>
                    <div class="form-group">
