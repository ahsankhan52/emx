...
@section('title', 'Edit Contact Page - EMX Auto Repair Admin')
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <!-- Main Content -->
            <div class="card mb-4">
                <div class="card-header">Contact Information / Content</div>
                <div class="card-body">
                    <div class="form-group">
                        <textarea class="form-control" id="contact_content" data-page-key="contact_content"
                            rows="10"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="seo_title" placeholder="Contact - EMX Auto Repair">
                    </div>
                    <div class="form-group">
