...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <!-- Main Content -->
            <div class="card mb-4">
                <div class="card-header">Privacy Policy Content</div>
                <div class="card-body">
                    <div class="form-group">
                        <textarea class="form-control" id="privacy_content" data-page-key="privacy_content"
                            rows="20"></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="seo_title"
                            placeholder="Privacy Policy - EMX Auto Repair">
                    </div>
                    <div class="form-group">
